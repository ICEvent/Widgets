...
import { idlFactory } from './iceventicket.did.js';
export { idlFactory } from './iceventicket.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = "rvzx7-oqaaa-aaaaj-qagxq-cai";//process.env.ICEVENTICKET_CANISTER_ID;
