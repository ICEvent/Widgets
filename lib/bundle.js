...
var Day = styled__default["default"].div(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral__default["default"](["\n  width: 14%;\n  line-height: 2rem;\n  display: flex;\n  align-items: center;\n  justify-content: center;\n  font-style: ", ";\n  cursor: ", ";\n  \n  ", "\n\n  ", "\n\n  ", "\n"])), function (props) {
  ...
  return props.hasEvents && styled.css(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral__default["default"](["\n      text-emphasis: filled circle crimson;\n      text-emphasis-position: under right;\n    "])));
}, function (props) {
...
const canisterId = "ukvuy-5aaaa-aaaaj-qabva-cai";
 ...
 */
 const createActor = (canisterId, options) => {
  new agent.HttpAgent({ ...options?.agentOptions });
 ...
 */
 const icevent = createActor(canisterId);

var Calendar = function Calendar() {
  var DAYS_OF_THE_WEEK = ['S', 'M', 'T', 'W', 'T', 'F', 'S'];

  var _useState = react.useState(105),
      _useState2 = _slicedToArray__default["default"](_useState, 2),
      myCalendarID = _useState2[0];
      _useState2[1]; //664 test calendar widget, 105 Defi Calendar
  ...
  var _useState5 = react.useState(moment__default["default"](new Date()).format('YYYYMMDD')),
      _useState6 = _slicedToArray__default["default"](_useState5, 2),
      selectedDate = _useState6[0],
      setSelectedDate = _useState6[1];

  var _useState7 = react.useState(moment__default["default"](new Date()).format("YYYYMM")),
      _useState8 = _slicedToArray__default["default"](_useState7, 2),
      currMonth = _useState8[0],
      setCurrMonth = _useState8[1];
  ...
  var _useState9 = react.useState([]),
      ...
      dates = _useState10[0],
      setDates = _useState10[1]; // const [dateEvents, setDateEvents] = useState([]);


  var fetchEvents = function fetchEvents(s, e) {
    icevent.getCalendarEvents(BigInt(myCalendarID), s.unix(), e.unix(), BigInt(1)).then(function (es) {
  ...
  var getDates = function getDates() {
    var currMonthArray = Array.from(Array(moment__default["default"](currMonth).daysInMonth()), function (dt, index) {
      return moment__default["default"](currMonth).startOf('month').add(index, 'd').format('YYYYMMDD');
    });
    var startDay = moment__default["default"](currMonth).startOf('month').day();
    var preMonthArray = startDay ? Array.from(Array(startDay), function (dt, index) {
      return moment__default["default"](currMonth).subtract(1, 'M').endOf('month').subtract(index, 'd').format('YYYYMMDD');
    }).reverse() : [];
    var nextMonthArray = Array.from(Array(6 - moment__default["default"](currMonth).endOf('month').day()), function (dt, index) {
      return moment__default["default"](currMonth).add(1, 'M').startOf('month').add(index, 'd').format('YYYYMMDD');
    });
    setDates([].concat(_toConsumableArray__default["default"](preMonthArray), _toConsumableArray__default["default"](currMonthArray), _toConsumableArray__default["default"](nextMonthArray)));
    return [preMonthArray[0], nextMonthArray[nextMonthArray.length - 1]];
  };

  var dateEvents = dates.map(function (date) {
    return {
      'date': date,
      'events': events.filter(function (es) {
        return moment__default["default"](es.start).format('YYYYMMDD') == date;
      })
    };
  });
  var dateLst = dateEvents.map(function (dtev) {
    return react$1.jsx(Day, {
      key: dtev.date,
      isToday: moment__default["default"](new Date()).format('YYYYMMDD') == dtev.date,
      isSelected: selectedDate == dtev.date,
      isCurrMonth: moment__default["default"](dtev.date).month() == moment__default["default"](currMonth),
      hasEvents: dtev.events.length > 0,
      onClick: function onClick() {
        return setSelectedDate(dtev.date);
      }
    }, moment__default["default"](dtev.date).date());
  });

  var preciousMonth = function preciousMonth() {
    var preMonth = moment__default["default"](currMonth).subtract(1, 'month').format('YYYYMM');
    setCurrMonth(preMonth);
  };

  var nextMonth = function nextMonth() {
    var nextMonth = moment__default["default"](currMonth).add(1, 'month').format('YYYYMM');
    setCurrMonth(nextMonth);
  };

  react.useEffect(function () {
    var _getDates = getDates(),
        _getDates2 = _slicedToArray__default["default"](_getDates, 2),
        startDate = _getDates2[0],
        endDate = _getDates2[1];

    fetchEvents(moment__default["default"](startDate), moment__default["default"](endDate));
  }, [currMonth]);
  return react$1.jsx(Frame, null, react$1.jsx(Header, null, react$1.jsx("div", null, moment__default["default"](currMonth).format("MMM YYYY")), react$1.jsx(ButtonGroup, null, react$1.jsx(Button, {
    onClick: preciousMonth
